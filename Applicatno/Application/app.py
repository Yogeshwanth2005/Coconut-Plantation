...
from PyQt5.QtGui import QPixmap, QPen, QBrush, QColor, QFont, QImage, QPainter,QCursor
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        cat_stats_action=QAction("stats per Category",self); cat_stats_action.triggered.connect(self.viewer.show_category_points_stats); props_menu.addAction(cat_stats_action)
